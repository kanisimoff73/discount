...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        --
        CREATE TABLE "main_app_products" ("id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "name" text NOT NULL, "photo" text NOT NULL, "price" double precision NOT NULL, "link" text NULL, "cat_id" bigint NOT NULL, "shop_id" bigint NOT NULL);
